...
echo ""
echo "[helpcenter] Listo. El pipeline nocturno se ejecutará todos los días a las 22:00h."
echo "  Pipeline: changelog (detectar cambios) → Notion sync (publicar artículos)"
echo "  Para ejecutar manualmente: npm run nightly"
echo "  Para ver logs: tail -f logs/nightly.log"
